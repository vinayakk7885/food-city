      ...
      <section className="w-full my-1">
        <div className="w-full flex items-center justify-between">
          ...
          <div className="hidden md:flex gap-4 items-center">
            <motion.div
              whileTap={{ scale:0.75 }}
              className="w-8 h-8 rounded-lg bg-orange-300 hover:bg-orange-500 cursor-pointer transition-all duration-100 ease-in-out hover:shadow-lg flex items-center justify-center" onClick={()=>setScrollValue(prevValue => prevValue - 200)}
            >
